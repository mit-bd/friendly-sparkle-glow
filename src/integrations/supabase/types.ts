    ...
    Tables: {
      ...
      budget_alerts: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "budget_alerts_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      damage_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: "damage_attachments_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      damage_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "damage_events_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      damage_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "damage_types_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      damages: {
        ...
        Relationships: [
          {
            foreignKeyName: "damages_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      expense_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "expense_comments_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      expense_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "expense_events_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      field_changes: {
        ...
        Relationships: [
          {
            foreignKeyName: "field_changes_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      fixed_cost_payments: {
        ...
        Relationships: [
          {
            foreignKeyName: "fixed_cost_payments_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      fixed_cost_templates: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "fixed_cost_templates_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      marketing_platforms: {
        ...
        Relationships: [
          {
            foreignKeyName: "marketing_platforms_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      payable_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "payable_events_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      qa_checklist_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "qa_checklist_items_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      receivable_collections: {
        ...
        Relationships: [
          {
            foreignKeyName: "receivable_collections_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      receivable_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "receivable_events_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      return_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: "return_attachments_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      return_reasons: {
        ...
        Relationships: [
          {
            foreignKeyName: "return_reasons_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
      ...
      signatories: {
        ...
        Relationships: [
          {
            foreignKeyName: "signatories_company_id_fkey"
            columns: ["company_id"]
            isOneToOne: false
            referencedRelation: "companies"
            referencedColumns: ["id"]
